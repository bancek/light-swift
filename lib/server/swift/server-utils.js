...
(function() {
  ...
  exports.formatObjects = function(objects, prefix, delimiter, path, marker, endMarker, limit) {
    var endIndex, index, indexObjects, objNameGetter, objs, objsMeta, pathMode, pfx;
    if (limit == null) {
      limit = 10000;
    }
    objs = _.keys(objects);
    ...
    objNameGetter = function(x) {
      var _ref;
      return (x != null) && ((_ref = x.name) != null ? _ref : x.subdir);
    };
    ...
    if (marker != null) {
      ...
      index = _.sortedIndex(indexObjects, {
        name: marker
      }, objNameGetter);
      if (marker < objNameGetter(indexObjects[index])) {
        index--;
      }
      objsMeta.splice(0, index);
    }
    if (endMarker != null) {
      endIndex = _.sortedIndex(objsMeta, {
        name: endMarker
      }, objNameGetter);
