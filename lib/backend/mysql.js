...
(function() {
  ...
  MysqlBackend = (function() {
    ...
    MysqlBackend.prototype.addObject = function(account, container, object, obj) {
      return q.ninvoke(this.pool, 'query', 'INSERT INTO `object` (\n  `account`,\n  `container`,\n  `object`,\n  `backend_object`,\n  `object_manifest`,\n  `content_type`,\n  `hash`,\n  `content_length`,\n  `last_modified`,\n  `metadata`\n) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [account, container, object, obj.object, obj.objectManifest, obj.contentType, obj.hash, obj.contentLength, obj.lastModified.getTime(), JSON.stringify(obj.metadata)]);
    };
